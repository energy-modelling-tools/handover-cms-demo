...
<section class="bg-gray-light py-5 fade-in-center">
 ...
 <!-- CMS:section id=get_involved_join_the_onsset_community -->
 ...
 <!-- CMS:section id=get_involved_collaborate_troubleshoot -->
 ...
 <!-- CMS:section id=get_involved_share_research -->
 ...
 <!-- CMS:section id=get_involved_follow_connect -->
 ...
 <!-- CMS:section id=get_involved_contribute_to_the_onsset_repository -->
