...
<section class="bg-gray-light container-lg p-responsive py-4 py-md-6 my-lg-6 fade-in-center"> 
  ...
  <div class="applications-content text-left">
    <!-- CMS:section id=application_onsset_applications -->
    <p class="lead mb-4">
    ...
    <div class="applications-grid">
      ...
      <div class="application-category">
        ...
        <!-- /CMS:section -->
        <!-- CMS:section id=application_governments_2 -->
      ...
      <div class="application-category">
        ...
        <!-- /CMS:section -->
        <!-- CMS:section id=application_academia_2 -->
        <ul class="application-list">
    ...
    <div class="slider-container">
      <div class="slider" id="textSlider">
        ...
        <div class="slide-card">
          ...
          <!-- CMS:section id=application_kenya_electrification_pathways -->
          <p>
        ...
        <div class="slide-card">
          ...
          <!-- CMS:section id=application_planning_with_justice_tanzania -->
          <p>
        ...
        <div class="slide-card">
          ...
          <!-- CMS:section id=application_urban_rural_electrification_data -->
          <p>
